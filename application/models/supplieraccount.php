...
class Supplieraccount extends CI_Model {
	...
	public function create($data){
		...
		$sql = "INSERT INTO ".$this->table." (username, password, contact_number, supplier_companyname, supplier_street, supplier_city, supplier_province  ,supplier_postal ,supplier_email  )
		VALUES
		(
		'".$data['username']."',
		'".$data['password']."',
